...
-webkit-backdrop-filter: blur(7.4px);
  ...
  <div class="bg-image"></div>
        ...
        <h4>
            Sorry we are maxed out for the event </br>
          </h4>
          <em style="padding:20px;"> However, we would love to stay in touch with you and keep you updated on our latest news, offers, and promotions. </em>
        ...
        <fieldset>
            ...
            <h2 class="success">Thank you for submitting your details. We have received them successfully!</h2>
            ...
            <h2 class="failed">Sorry but Email address already exists in our records</h2>
